    ...
    <div>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography>Educacion</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel4a-header"
        >
          <Typography>Kinesiólogo</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
